...
public class FoodTypeAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            ...
            groupHolder.ivArrow=view.findViewById(R.id.iv_arrow);
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            ...
            childHolder.childLine=view.findViewById(R.id.view_child);
            childHolder.groupLine=view.findViewById(R.id.view_group);
    ...
    class ChildHolder{
        ...
        private View childLine,groupLine;
    }
}
