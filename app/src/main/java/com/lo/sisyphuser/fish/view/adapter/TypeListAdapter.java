...
import com.lo.sisyphuser.fish.view.FoodDetailActivity;
import com.lo.sisyphuser.fish.view.TypeListActivity;
...
public class TypeListAdapter extends RecyclerView.Adapter<TypeListAdapter.Holder> {
    ...
    public TypeListAdapter(Context context, List<Food> list,TypeListActivity.TypeListCallBack callBack) {
